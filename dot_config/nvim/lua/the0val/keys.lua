...
m.nnoremap("<F5>", require"dap".continue)
m.nnoremap("<F6>", require"dap".step_into)
m.nnoremap("<F7>", require"dap".step_over)
m.nnoremap("<F8>", require"dap".step_out)
m.nnoremap("<F9>", require"dap".step_back)
m.nnoremap("<F11>", require"dap".run_last)
m.nnoremap("<F12>", require"dap".terminate)
...
m.nnoremap("<Leader>dr", require"dapui".toggle)
